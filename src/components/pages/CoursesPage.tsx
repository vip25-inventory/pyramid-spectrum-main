  ...
  return (
    <div className="courses-home">
      <Helmet>
        ...
        <link rel="canonical" href={getCanonicalUrl("/courses")} />
      </Helmet>
...
// NEET course page component
const NEETCoursePage = () => {
  return (
    <div className="neet-courses">
      <Helmet>
        <title>NEET Preparation Courses | SPECTRUM Education</title>
        <meta name="description" content="Join SPECTRUM's comprehensive NEET coaching program with expert faculty, regular tests, and proven results. Our students consistently achieve top ranks in medical entrance exams." />
        <meta name="keywords" content="NEET preparation, NEET coaching, medical entrance exam, NEET online coaching, SPECTRUM education" />
        <link rel="canonical" href={getCanonicalUrl("/courses/spectrum/neet")} />
      </Helmet>
      <main className="container">
        <Breadcrumbs 
          customPaths={[
            { path: '/courses', label: 'Courses' },
            { path: '/courses/spectrum', label: 'Spectrum' },
            { path: '/courses/spectrum/neet', label: 'NEET' }
          ]} 
        />
        <header className="page-header">
          <h1>NEET Courses</h1>
          <p>Comprehensive Medical Entrance Exam Preparation</p>
        </header>
        
        {/* Online Coaching for NEET Section */}
        <section className="section online-coaching">
          <div className="row g-4 align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="online-coaching-content">
                <h2 className="text-center">Online Coaching for <span>NEET</span></h2>
                ...
                <div className="d-flex align-items-start mb-3">
                  ...
                  <p>
                    NEET Online Coaching by SPECTRUM is perfect for students focused on <span className="fw-bold">achieving their goals</span>.
                  </p>
                </div>
                ...
                <div className="d-flex align-items-start mb-4">
                  ...
                  <p>
                    With <span className="fw-bold">SPECTRUM's expert faculty</span> and <span className="fw-bold">a result-oriented learning platform</span>, you're not just studying—you're improving every single day.
                  </p>
                </div>
            ...
            <div className="col-lg-6 col-md-12">
              <div className="online-coaching-image">
                <img 
                  ...
                  alt="SPECTRUM's Expert NEET Online Coaching Program with Proven Results" 
                  className="img-fluid"
                />
              </div>
            </div>
        ...
        {/* Toppers and Results Section */}
        <section className="section neet-toppers-results">
          <div className="row g-4">
            {/* Left Container - Toppers */}
            <div className="col-lg-5 col-md-12">
              <div className="toppers-container">
                <h2>Toppers choose <span className="text-success">SPECTRUM</span></h2>
                
                <div className="toppers-gallery">
                  <div className="topper-profile side text-center side-lowered">
                    {/* <div className="topper-badge">720/720</div> */}
                    <div className="topper-image">
                      <img src="/images/users/neet-1.jpg" alt="NEET Topper Aditya S with Perfect Score" className="rounded-circle" />
                    </div>
                    <h3 className="mt-2 mb-0">Aditya S</h3>
                  </div>
                  
                  <div className="topper-profile center text-center">
                    {/* <div className="topper-badge">720/720</div> */}
                    <div className="topper-image">
                      <img src="/images/users/neet-2.png" alt="NEET Topper Priya with Perfect Score" className="rounded-circle" />
                    </div>
                    <h3 className="mt-2 mb-0">Priya</h3>
                  </div>
                  
                  <div className="topper-profile side text-center side-lowered">
                    {/* <div className="topper-badge">720/720</div> */}
                    <div className="topper-image">
                      <img src="/images/users/neet-3.png" alt="NEET Topper Rahul V with Perfect Score" className="rounded-circle" />
                    </div>
                    <h3 className="mt-2 mb-0">Rahul V</h3>
                  </div>
                </div>
            ...
            {/* Right Container - Results Statistics */}
            <div className="col-lg-7 col-md-12">
              <div className="results-container">
                <h2>Outstanding <span className="text-primary">NEET</span> <span className="text-success">100% results</span> consistently</h2>
                
                <div className="row g-4 mt-3">
                  <div className="col-md-6">
                    <div className="result-stat-card border-success">
                      <h3 className="text-success fs-1 mb-0">35,825</h3>
                      <p className="mb-0">Eligible in NEET mains</p>
                    </div>
                  </div>
                  
                  <div className="col-md-6">
                    <div className="result-stat-card border-primary">
                      <h3 className="text-primary fs-1 mb-0">12,540</h3>
                      <p className="mb-0">Qualified for medical admissions</p>
                    </div>
                  </div>
                  
                  <div className="col-md-6">
                    <div className="result-stat-card border-primary">
                      <h3 className="text-primary fs-1 mb-0">65</h3>
                      <p className="mb-0">Students in top 100</p>
                    </div>
                  </div>
                  
                  <div className="col-md-6">
                    <div className="result-stat-card border-success">
                      <h3 className="text-success fs-1 mb-0">120</h3>
                      <p className="mb-0">Students in top 200</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Comprehensive NEET courses section */}
        {/* <section className="section comprehensive-neet-courses">
          <h2>Comprehensive NEET Preparation</h2>
          <div className="row g-4 mt-3">
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="course-category-card d-flex flex-column h-100">
                <div className="course-type-badge live">
                  <i className="fas fa-video"></i>
                  <span>LIVE</span>
                </div>
                <h3>Complete NEET Course Package</h3>
                <p>All-inclusive preparation for NEET aspirants</p>
                
                <div className="course-features mt-auto mb-3">
                  <ul className="mb-4">
                    <li>Live classes from SPECTRUM's expert faculty</li>
                    <li>Comprehensive study material with solved examples</li>
                    <li>Regular mock tests with detailed analysis</li>
                    <li>24/7 doubt resolution and academic guidance</li>
                    <li>Performance tracking and personalized feedback</li>
                  </ul>
                </div>
                
                <div className="pricing-info mb-3">
                  <span className="text-decoration-line-through text-muted me-2">₹1,45,000</span>
                  <span className="fs-4 fw-bold">₹1,15,000</span>
                  <span className="text-muted ms-2">+ Taxes applicable</span>
                </div>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="course-category-card d-flex flex-column h-100">
                <div className="course-type-badge test-series">
                  <i className="fas fa-clipboard-check"></i>
                  <span>ONLINE TEST SERIES</span>
                </div>
                <h3>NEET Test Series</h3>
                <p>Intensive practice with NEET pattern tests</p>
                
                <div className="course-features mt-auto mb-3">
                  <ul className="mb-4">
                    <li>30+ Full & Subject-wise Tests</li>
                    <li>Performance comparison with toppers</li>
                    <li>Detailed video solutions for difficult questions</li>
                    <li>Topic-wise analysis to identify weak areas</li>
                    <li>Regular updates with new question patterns</li>
                  </ul>
                </div>
                
                <div className="pricing-info mb-3">
                  <span className="text-decoration-line-through text-muted me-2">₹15,400</span>
                  <span className="fs-4 fw-bold">₹11,200</span>
                  <span className="text-muted ms-2">+ Taxes applicable</span>
                </div>
...
// JEE course page component
const JEECoursePage = () => {
  return (
    <div className="jee-courses">
      <Helmet>
        <title>IIT-JEE Preparation Courses | SPECTRUM Education</title>
        <meta name="description" content="Prepare for IIT-JEE with SPECTRUM's expert coaching programs. Our structured approach focuses on conceptual clarity and proven strategies that have helped students secure top ranks in JEE Main and Advanced." />
        <meta name="keywords" content="IIT-JEE preparation, JEE coaching, engineering entrance exam, JEE Main, JEE Advanced, SPECTRUM education" />
        <link rel="canonical" href={getCanonicalUrl("/courses/spectrum/iit-jee")} />
      </Helmet>
      <div className="container">
        <Breadcrumbs 
          customPaths={[
            { path: '/courses', label: 'Courses' },
            { path: '/courses/spectrum', label: 'Spectrum' },
            { path: '/courses/spectrum/iit-jee', label: 'IIT-JEE' }
          ]} 
        />
        <div className="page-header">
          <h1>IIT-JEE Courses</h1>
          <p>Comprehensive Engineering Entrance Exam Preparation</p>
        </div>
        
        {/* Online Coaching for JEE Section */}
        <div className="section online-coaching">
          <div className="row g-4 align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="online-coaching-content">
                <h2 className="text-center">Online Coaching for <span>IIT-JEE</span></h2>
                ...
                <div className="d-flex align-items-start mb-3">
                  ...
                  <p>
                    IIT-JEE Online Coaching by SPECTRUM is perfect for students focused on <span className="fw-bold">achieving their engineering dreams</span>.
                  </p>
                </div>
            ...
            <div className="col-lg-6 col-md-12">
              <div className="online-coaching-image">
                <img 
                  ...
                  alt="SPECTRUM's IIT-JEE Online Coaching with Strategic Preparation Methods" 
                  className="img-fluid"
                />
              </div>
            </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-5 col-md-12">
              <div className="toppers-container">
                ...
                <div className="toppers-gallery">
                  <div className="topper-profile side text-center side-lowered">
                    {/* <div className="topper-badge">360/360</div> */}
                    <div className="topper-image">
                      <img src="/images/users/iit-1.png" alt="JEE Topper Ankit K with Perfect Score" className="rounded-circle" />
                    </div>
                    <h3 className="mt-2 mb-0">Ankit K</h3>
                  </div>
                  
                  <div className="topper-profile center text-center">
                    {/* <div className="topper-badge">360/360</div> */}
                    <div className="topper-image">
                      <img src="/images/users/iit-2.png" alt="JEE Topper Vikram with Perfect Score" className="rounded-circle" />
                    </div>
                    <h3 className="mt-2 mb-0">Vikram</h3>
                  </div>
                  
                  <div className="topper-profile side text-center side-lowered">
                    {/* <div className="topper-badge">355/360</div> */}
                    <div className="topper-image">
                      <img src="/images/users/iit-3.jpg" alt="JEE Topper Nisha P with Near-Perfect Score" className="rounded-circle" />
                    </div>
                    <h3 className="mt-2 mb-0">Nisha P</h3>
                  </div>
                </div>
            ...
            <div className="col-lg-7 col-md-12">
              <div className="results-container">
                <h2>Outstanding <span className="text-primary">IIT-JEE</span> <span className="text-success">100% results</span> consistently</h2>
                
                <div className="row g-4 mt-3">
                  <div className="col-md-6">
                    <div className="result-stat-card border-success">
                      <h3 className="text-success fs-1 mb-0">42,750</h3>
                      <p className="mb-0">Eligible in JEE Main</p>
                    </div>
                  </div>
                  
                  <div className="col-md-6">
                    <div className="result-stat-card border-primary">
                      <h3 className="text-primary fs-1 mb-0">15,280</h3>
                      <p className="mb-0">Qualified for JEE Advanced</p>
                    </div>
                  </div>
                  
                  <div className="col-md-6">
                    <div className="result-stat-card border-primary">
                      <h3 className="text-primary fs-1 mb-0">45</h3>
                      <p className="mb-0">Students in top 100</p>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="result-stat-card border-success">
                      <h3 className="text-success fs-1 mb-0">95</h3>
                      <p className="mb-0">Students in top 200</p>
                    </div>
                  </div>
                </div>
        ...
        {/* Explore our JEE courses Section */}
        {/* <div className="section explore-jee-courses">
          <h2>Explore our IIT-JEE courses</h2>
          
          <div className="class-filters mb-4">
            <div className="d-flex justify-content-center flex-wrap">
              <button 
                className="btn rounded-0 mx-2 mb-2"
                style={{
                  backgroundColor: activeFilter === "Class 11" ? "#2a50a2" : "transparent",
                  color: activeFilter === "Class 11" ? "#fff" : "#2a50a2",
                  borderColor: "#1565C0",
                  borderWidth: "1px",
                  borderStyle: "solid",
                  padding: "0.5rem 1.5rem"
                }}
                onClick={() => setActiveFilter("Class 11")}
              >
                Class 11
              </button>
              ...
              <button 
                className="btn rounded-0 mx-2 mb-2"
                style={{
                  backgroundColor: activeFilter === "Class 12" ? "#2a50a2" : "transparent",
                  color: activeFilter === "Class 12" ? "#fff" : "#2a50a2",
                  borderColor: "#1565C0",
                  borderWidth: "1px",
                  borderStyle: "solid",
                  padding: "0.5rem 1.5rem"
                }}
                onClick={() => setActiveFilter("Class 12")}
              >
                Class 12
              </button>
          ...
          <div className="row g-4">
            {courseData[activeFilter].map((course: CourseItem, index: number) => (
              <div className="col-lg-6 col-md-6 col-sm-12" key={index}>
                <div className="course-category-card d-flex flex-column h-100">
                  <div className={`course-type-badge ${
                    course.type === "LIVE" ? "live" : 
                    course.type === "ONLINE TEST SERIES" ? "test-series" : "recorded"
                  }`}>
                    {course.type === "LIVE" ? (
                      <i className="fas fa-video"></i>
                    ) : course.type === "ONLINE TEST SERIES" ? (
                      <i className="fas fa-clipboard-check"></i>
                    ) : (
                  ...
                  <div className="pricing-info mb-3">
                    <span className="text-decoration-line-through text-muted me-2">{course.originalPrice}</span>
                    <span className="fs-4 fw-bold">{course.discountedPrice}</span>
                    <span className="text-muted ms-2">+ Taxes applicable</span>
                  </div>
  ...
  return (
    <div className="english-courses spoken-english-page">
      <Helmet>
        ...
        <link rel="canonical" href={getCanonicalUrl("/courses/pyramid/english")} />
      </Helmet>
      <div className="container">
        <Breadcrumbs 
          customPaths={[
            { path: '/courses', label: 'Courses' },
            { path: '/courses/pyramid', label: 'Pyramid' },
            { path: '/courses/pyramid/english', label: 'Spoken English' }
          ]} 
        />
        <div className="page-header">
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              <div className="english-course-card h-100 d-flex flex-column">
                ...
                <div className="text-center mt-auto">
                  <CollisionButton 
                    text="View Details"
                    href="/courses/pyramid/english/basic"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              <div className="english-course-card h-100 d-flex flex-column">
                ...
                <div className="text-center mt-auto">
                  <CollisionButton 
                    text="View Details"
                    href="/courses/pyramid/english/advanced"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              <div className="english-course-card h-100 d-flex flex-column">
                ...
                <div className="text-center mt-auto">
                  <CollisionButton 
                    text="View Details"
                    href="/courses/pyramid/english/practical"
                  />
                </div>
              </div>
            </div>
        ...
        {/* <div className="section cta-section">
          <div className="cta-content">
            <h2>Begin Your English Learning Journey Today</h2>
            <p>Gain confidence, improve your career prospects, and open new opportunities with enhanced communication skills</p>
            <div className="cta-buttons">
              <AnimatedButton 
                text="Contact Us"
                href="/contact"
                className="english-enroll-btn"
              />
            </div>
          </div>
        </div> */}
  ...
  return (
    <div className="english-courses spoken-english-page">
      <Helmet>
        ...
        <link rel="canonical" href={getCanonicalUrl("/courses/pyramid/english/basic")} />
        <style type="text/css">{`
      ...
      <div className="container">
        <Breadcrumbs 
          customPaths={[
            ...
            { path: '/courses/pyramid', label: 'Pyramid' },
            { path: '/courses/pyramid/english', label: 'Spoken English' },
            { path: '/courses/pyramid/english/basic', label: 'Basic English' }
          ]} 
        />
        <div className="page-header">
  ...
  return (
    <div className="advanced-english spoken-english-page">
      <Helmet>
        ...
        <link rel="canonical" href={getCanonicalUrl("/courses/pyramid/english/advanced")} />
        <style type="text/css">{`
      ...
      <div className="container">
        <Breadcrumbs 
          customPaths={[
            ...
            { path: '/courses/pyramid', label: 'Pyramid' },
            { path: '/courses/pyramid/english', label: 'Spoken English' },
            { path: '/courses/pyramid/english/advanced', label: 'Advanced English' }
          ]} 
        />
        <div className="page-header">
  ...
  return (
    <div className="practical-english spoken-english-page">
      <Helmet>
        ...
        <link rel="canonical" href={getCanonicalUrl("/courses/pyramid/english/practical")} />
        <style type="text/css">{`
      ...
      <div className="container">
        <Breadcrumbs 
          customPaths={[
            ...
            { path: '/courses/pyramid', label: 'Pyramid' },
            { path: '/courses/pyramid/english', label: 'Spoken English' },
            { path: '/courses/pyramid/english/practical', label: 'Practical English' }
          ]} 
        />
        <div className="page-header">
  ...
  return (
    <div className="foundation-program pyramid-page">
      <Helmet>
        ...
        <link rel="canonical" href={getCanonicalUrl("/courses/pyramid/foundation")} />
      </Helmet>
      <div className="container">
        <Breadcrumbs 
          customPaths={[
            { path: '/courses', label: 'Courses' },
            { path: '/courses/pyramid', label: 'Pyramid' },
            { path: '/courses/pyramid/foundation', label: 'Foundation & Academics Program' }
          ]} 
        />
        <div className="page-header">
        ...
        {/* <div className="section cta-section">
          <div className="cta-content">
            <h2>Enroll in Our Foundation Program Today</h2>
            <p>Build a strong academic foundation and set yourself up for future success</p>
            <div className="cta-buttons">
              <AnimatedButton 
                text="Contact Us"
                href="/contact"
                className="foundation-enroll-btn"
              />
            </div>
          </div>
        </div> */}
  ...
  return (
    <div className="power-program pyramid-page">
      <Helmet>
        ...
        <link rel="canonical" href={getCanonicalUrl("/courses/pyramid/power-program")} />
      </Helmet>
      <div className="container">
        <Breadcrumbs 
          customPaths={[
            { path: '/courses', label: 'Courses' },
            { path: '/courses/pyramid', label: 'Pyramid' },
            { path: '/courses/pyramid/power-program', label: 'Power Program' }
          ]} 
        />
        <div className="page-header">
          <h1>Power Program</h1>
        ...
        {/* <div className="section cta-section">
          <div className="cta-content">
            <h2>Join Our Power Program Today</h2>
            <p>Accelerate your academic journey and prepare for competitive excellence</p>
            <div className="cta-buttons">
              <AnimatedButton 
                text="Contact Us"
                href="/contact"
                className="power-program-enroll-btn"
              />
            </div>
          </div>
        </div> */}
...
// Add new Spectrum page component
const SpectrumPage = () => {
  return (
    <div className="spectrum-page">
      <Helmet>
        <title>Spectrum Courses - NEET & IIT-JEE | SPECTRUM Education</title>
        <meta name="description" content="SPECTRUM's premier coaching for competitive exams NEET and IIT-JEE. Specialized curriculum and expert mentorship for medical and engineering aspirants." />
        <meta name="keywords" content="NEET coaching, IIT-JEE preparation, medical entrance, engineering entrance, SPECTRUM education" />
        <link rel="canonical" href={getCanonicalUrl("/courses/spectrum")} />
        <style type="text/css">{`
          .spectrum-page .academic-programs .program-icon {
            transition: all 0.3s ease;
          }
          .spectrum-page .academic-programs .academic-program-card:hover .program-icon {
  ...
  return (
    <div className="pyramid-page">
      <Helmet>
        ...
        <link rel="canonical" href={getCanonicalUrl("/courses/pyramid")} />
      </Helmet>
      <main className="container">
        <Breadcrumbs 
          customPaths={[
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="academic-program-card h-100 d-flex flex-column">
                ...
                <div className="mt-auto text-center">
                  <CollisionButton
                    text="Learn More"
                    href="/courses/pyramid/foundation"
                    className="px-4"
                  />
                </div>
              </div>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="academic-program-card h-100 d-flex flex-column">
                ...
                <div className="mt-auto text-center">
                  <CollisionButton
                    text="Learn More"
                    href="/courses/pyramid/power-program"
                    className="px-4"
                  />
                </div>
              </div>
        ...
        <section className="section handwriting-calligraphy" style={{ backgroundColor: "transparent", boxShadow: "none" }}>
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="course-card mb-0">
                {/* <div className="course-img">
                  <img src="/images/handwriting.webp" alt="SPECTRUM's Handwriting Improvement Classes in Multiple Languages" />
                </div> */}
            ...
            <div className="col-md-6">
              <div className="course-card mb-0">
                {/* <div className="course-img">
                  <img src="/images/calligraphy.webp" alt="SPECTRUM's Professional Calligraphy Training for All Levels" />
                </div> */}
                <div className="course-content">
    ...
    "itemListElement": [
      {
        ...
        "description": "Comprehensive coaching for medical entrance exam preparation",
        "provider": {
          "@type": "Organization",
          "name": "SPECTRUM Education",
          "sameAs": "https://www.spectrum-education.com"
        }
      },
      {
        "@type": "Course",
      ...
      {
        "@type": "Course",
        "name": "Spoken English Programs",
        "description": "Language courses for all proficiency levels focusing on practical communication",
        "provider": {
          "@type": "Organization",
          "name": "SPECTRUM Education",
          "sameAs": "https://www.spectrum-education.com"
  ...
  return (
    <div className="courses-page">
      ...
      <Routes>
        ...
        <Route path="/spectrum/neet" element={<NEETCoursePage />} />
        <Route path="/spectrum/iit-jee" element={<JEECoursePage />} />
        ...
        <Route path="/neet" element={<Navigate to="/courses/spectrum/neet" replace />} />
        <Route path="/iit-jee" element={<Navigate to="/courses/spectrum/iit-jee" replace />} />
        <Route path="/english" element={<Navigate to="/courses/pyramid/english" replace />} />
        <Route path="/english/basic" element={<Navigate to="/courses/pyramid/english/basic" replace />} />
        <Route path="/english/advanced" element={<Navigate to="/courses/pyramid/english/advanced" replace />} />
        <Route path="/english/practical" element={<Navigate to="/courses/pyramid/english/practical" replace />} />
